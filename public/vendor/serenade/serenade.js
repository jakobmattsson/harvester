...
(function(root) {
  ...
  exports.Collection = (function() {
    ...
    Collection.prototype.update = function(list) {
      var element, _i, _j, _len, _len1, _ref1;
      _ref1 = this.list;
    ...
    Collection.prototype.sort = function(fun) {
      this.list.sort(fun);
      return this.trigger("update", this.list);
    };
    ...
    Collection.prototype._in = function(item) {
      var _ref1;
      if (item != null ? item._useDefer : void 0) {
        item._inCollections || (item._inCollections = []);
        return (_ref1 = item._inCollections) != null ? _ref1.push(this) : void 0;
      }
    };
  ...
  var exports = this;
  (function() {
  var AssociationCollection, Associations, Collection, extend, get, map, pairToObject, _ref;
    ...
    hasMany: function(name, attributes) {
      ...
      return this.property(name + 'Ids', {
        ...
        set: function(ids) {
          ...
          this.attributes[name] = new AssociationCollection(attributes.as, objects);
          return this._defer(name);
        },
        dependsOn: name,
  ...
  Serenade = {
    ...
    controllerFor: function(name, model) {
      if (this._controllers[name]) {
        return new this._controllers[name](model);
      }
    },
  ...
  Node = (function() {
    ...
    function Node(ast, document, model, controller) {
      var child, property, _i, _j, _len, _len1, _ref1, _ref2, _ref3;
      this.ast = ast;
      ...
      if (this.ast.id) {
        this.element.setAttribute('id', this.ast.id);
      }
      if ((_ref1 = this.ast.classes) != null ? _ref1.length : void 0) {
  ...
  If = (function() {
    ...
    If.prototype.build = function() {
      var child, i, node, _i, _len, _ref1, _ref2, _results;
      if (get(this.model, this.ast["arguments"][0])) {
        ...
        for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
          node = _ref1[i];
          _results.push(node.insertAfter(((_ref2 = this.nodes[i - 1]) != null ? _ref2.lastElement() : void 0) || this.anchor));
        }
        return _results;
      } else {
    ...
    If.prototype.lastElement = function() {
      var _ref1;
      if ((_ref1 = this.nodes) != null ? _ref1.length : void 0) {
  ...
  In = (function() {
    ...
    In.prototype.build = function() {
      var child, i, node, subModel, _i, _len, _ref1, _ref2, _results;
      this.removeNodes();
  ...
  CollectionItem = (function() {
    ...
    CollectionItem.prototype.insertAfter = function(element) {
      var last, node, _i, _len, _ref1, _results;
      last = element;
      _ref1 = this.nodes;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
...
if (typeof module !== 'undefined' && require.main === module) {
  ...
  Serenade.Properties = {
    ...
    get: function(name) {
      var _ref1;
      this.attributes || (this.attributes = {});
      if ((_ref1 = this[prefix + name]) != null ? _ref1.get : void 0) {
    ...
    format: function(name) {
      var format, _ref1;
      format = (_ref1 = this[prefix + name]) != null ? _ref1.format : void 0;
    ...
    _defer: function(name) {
      ...
      if ((deferred != null) && (deferred != null ? deferred._useDefer : void 0)) {
        deferred._deferTo || (deferred._deferTo = {});
        return (_ref1 = deferred._deferTo) != null ? _ref1[name] = this : void 0;
      }
    },
    ...
    _triggerChangesTo: function(changedProperties) {
      var allDefers, changes, checkDependenciesFor, collection, deferName, deferObject, keys, name, normalizeDeps, prop, value, _i, _j, _k, _len, _len1, _len2, _ref1, _results,
        _this = this;
      normalizeDeps = function(deps) {
        return [].concat(deps);
      };
      checkDependenciesFor = function(toCheck) {
        var name, property, _ref1, _results;
        _results = [];
        for (name in _this) {
          property = _this[name];
          if (name.match(exp) && property.dependsOn) {
            if (__indexOf.call(normalizeDeps(property.dependsOn), toCheck) >= 0 && (_ref1 = property.name, __indexOf.call(changedProperties, _ref1) < 0)) {
      ...
      changes = {};
      for (_j = 0, _len1 = changedProperties.length; _j < _len1; _j++) {
